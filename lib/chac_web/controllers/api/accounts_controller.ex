defmodule ChacWeb.AccountsController do
  use ChacWeb, :controller

  alias Chac.{AccountContext, ConsolidationContext}
  ...
  @doc """
    ...
    ---| swagger |---
      ...
      ChacWeb.Response.swagger 200, data: Chac.Core.Account._swagger_schema_(:basic)
    ---| end |---
  """
  ...
  @doc """
    ...
    ---| swagger |---
      ...
      ChacWeb.Response.swagger 200, data: "access_password_updated"
    ---| end |---
  """
  ...
  @doc """
    ...
    ---| swagger |---
      ...
      ChacWeb.Response.swagger 200, data: "transaction_password_updated"
    ---| end |---
  """
  ...
  @doc """
    ...
    ---| swagger |---
      ...
      ChacWeb.Response.swagger 200, Chac.Core.Account._swagger_schema_(:basic)
    ---| end |---
  """
  ...
  @doc """
    ...
    ---| swagger |---
      ...
      ChacWeb.Response.swagger 200, data: [Chac.Core.Consolidation._swagger_schema_(:account_owner)]
    ---| end |---
  """
